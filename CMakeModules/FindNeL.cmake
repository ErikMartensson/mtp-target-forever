...
# Fall back to release libs when debug libs are not found
# This allows CI builds that only build Release to work
IF(WIN32)
  IF(NOT NELMISC_LIBRARY_DEBUG AND NELMISC_LIBRARY)
    SET(NELMISC_LIBRARY_DEBUG ${NELMISC_LIBRARY})
  ENDIF()
  IF(NOT NEL3D_LIBRARY_DEBUG AND NEL3D_LIBRARY)
    SET(NEL3D_LIBRARY_DEBUG ${NEL3D_LIBRARY})
  ENDIF()
  IF(NOT NELGEORGES_LIBRARY_DEBUG AND NELGEORGES_LIBRARY)
    SET(NELGEORGES_LIBRARY_DEBUG ${NELGEORGES_LIBRARY})
  ENDIF()
  IF(NOT NELNET_LIBRARY_DEBUG AND NELNET_LIBRARY)
    SET(NELNET_LIBRARY_DEBUG ${NELNET_LIBRARY})
  ENDIF()
  IF(NOT NELPACS_LIBRARY_DEBUG AND NELPACS_LIBRARY)
    SET(NELPACS_LIBRARY_DEBUG ${NELPACS_LIBRARY})
  ENDIF()
  IF(NOT NELLIGO_LIBRARY_DEBUG AND NELLIGO_LIBRARY)
    SET(NELLIGO_LIBRARY_DEBUG ${NELLIGO_LIBRARY})
  ENDIF()
  IF(NOT NELSNDDRV_LIBRARY_DEBUG AND NELSNDDRV_LIBRARY)
    SET(NELSNDDRV_LIBRARY_DEBUG ${NELSNDDRV_LIBRARY})
  ENDIF()
  IF(NOT NELSOUND_LIBRARY_DEBUG AND NELSOUND_LIBRARY)
    SET(NELSOUND_LIBRARY_DEBUG ${NELSOUND_LIBRARY})
  ENDIF()
ENDIF()
