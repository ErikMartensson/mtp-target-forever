...
**Last updated:** 2026-04-25 (KI #19 + KI #17a fixed)
...
1. **KI #17b/c — scoreboard not live + score persists across rounds.** Bigger investigation. False trail noted in KI #17 (don't try the Entity vs CEntity init fix, it's a no-op). Real cause likely in scoreboard read path; affects all gates levels, sun_extra_ball, donuts2 — all share non-standard round-end conditions.
