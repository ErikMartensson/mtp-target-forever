...
function CLevel:init()
	...
	local m = self:addModuleNPSS("snow_torus", CVector(2.5,-6,6.02), 0, CVector(200, 100, 20)) m:setRotation(CAngleAxis(10,0,0,1.57))
	local m = self:addModuleNPSS("snow_torus", CVector(2.5,-6,6.01), 0, CVector(400, 200, 20)) m:setRotation(CAngleAxis(10,0,0,1.57))
	...
	local m = self:addModuleNPSS("snow_torus", CVector(1,-8,5.01), 0, CVector(200, 100, 20)) m:setRotation(CAngleAxis(10,0,0,1.57))
	...
	m:setFriction(1)
	local m = self:addModuleNPSS("snow_tube", CVector(2,-8.5,3.51), 0, CVector(3,3,5))
	m:setFriction(1)
	...
	-- plateform
	local m = self:addSunModule("box", "wood", 0, CVector(2,-8.8, 3.22), CVector(30, 1, 1))
	m:setFriction(3)
	m:setAccel(0.0001)
	local m = self:addSunModule("box", "wood", 0, CVector(2,-8.2, 3.22), CVector(30, 1, 1))
	m:setFriction(3)
	m:setAccel(0.0001)
	local m = self:addSunModule("box", "wood", 0, CVector(2,-8.5, 3.2), CVector(30, 30, 1))
	m:setFriction(3)
	m:setAccel(0.0001)
	...
	local m = self:addModuleNPSS("snow_box", CVector(-0.5,-8.5, 2.7), 50, CVector(50, 20, 1))
	m:setFriction(2)
